...
void fetch_value_of_big_prime_number(mp_int& big_prime_number) {
    /*
     * Initializes a big prime number (RFC 7919 group 4096-bit) for use in modular operations
     * Source: https://datatracker.ietf.org/doc/html/rfc7919#appendix-A.1
     */
    const char* rfc7919_prime_hex = 
    ...
    mp_err err = mp_read_radix(&big_prime_number, rfc7919_prime_hex, 16);
    if (err != MP_OKAY) {
